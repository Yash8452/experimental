...
export default function AboutSection() {
    const words = `A eager, flexible learner who aspires to be a full-stack web developer skilled with the MERN stack. I'm
        ...
        <div className="h-[100vh] w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex items-center justify-center">
            ...
            <div className="h-[100vh] text-white  w-full flex flex-col items-center justify-around  overflow-hidden rounded-md">
                ...
                <div className="p-4 md:px-36">
                    ...
                    <TextGenerateEffect className="italic font-light text-lg md:mt-0  md:text-2xl text-center mb-4" words={words} />
